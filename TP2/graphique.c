...
//fonction qui crée un sous fenetre ou se trouvera l'image
//le coin inferieur gauche est en largeur/2 - cote/2,hauteur/2 -cote/2
//la taille de la fenetre est cote, cote
